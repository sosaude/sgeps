...
class SendNewPasswordThroughAdminMail extends Mailable
{
    ...
    {
        return $this
        ->subject('Credenciais por meio do Administrador')
        ->markdown('mails.credentials.send_new_password_through_admin')
        ->with([
            'nome' => $this->user->nome,
