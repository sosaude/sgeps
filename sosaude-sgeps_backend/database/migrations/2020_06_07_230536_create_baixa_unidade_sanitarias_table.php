...
class CreateBaixaUnidadeSanitariasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('baixa_unidade_sanitarias', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('baixa_unidade_sanitarias');
    }
}
